...
namespace Tests
{
    ...
    class FunkcijeTest
    {
        ...
        public void FunkcijaMin()//kad sve radi
        {
            ...
            Assert.AreEqual(Convert.ToDateTime("6 / 7 / 2021 10:04:26"), rez.VremeProracuna);
            Assert.AreEqual(Convert.ToDateTime("6 / 7 / 2021 10:04:26"), rez.PoslednjeVreme);
        ...
        [Test]
        public void FunkcijaMax()//kad sve radi
        {
            rapom.Reset();
            ra = rapom.Object;
            ra.Id = 1;
            ...
            IRacunanje rez = testingDummy.FunkcijaMax(da, ra);
        ...
        [Test]
        public void FunkcijaMaxNeradi()//kad sve radi
        {
            rapom.Reset();
            ra = rapom.Object;
            ra.Id = 1;
        ...
        [Test]
        public void FunkcijaMaxGranica()//kad sve radi
        {
            rapom.Reset();
            ra = rapom.Object;
            ra.Id = 1;
        ...
        [Test]
        public void FunkcijaAvg()//kad sve radi
        {
            rapom.Reset();
            ra = rapom.Object;
            ra.Id = 1;
            ...
            IRacunanje rez = testingDummy.FunkcijaAvg(da, ra);
        ...
        [Test]
        public void FunkcijaAvgNeradi()//kad sve radi
        {
            rapom.Reset();
            ra = rapom.Object;
            ra.Id = 1;
        ...
        [Test]
        public void FunkcijaAvgGranica()//kad sve radi
        {
            rapom.Reset();
            ra = rapom.Object;
            ra.Id = 1;
